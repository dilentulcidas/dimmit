...
/**
 * Crucial, gonna use this class to get what i need from the monitors...
 * Based from https://github.com/java-native-access/jna/blob/master/contrib/monitordemo/src/com/sun/jna/contrib/demo/MonitorInfoDemo.java
 *
 * Supposedly only works for Windows though...
 */
public class MonitorsDemoClass
{
    ...
    private static void enumerate(HMONITOR hMonitor)
    {
