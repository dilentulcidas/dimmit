 ...
 *
 * Source: https://raw.githubusercontent.com/java-native-access/jna/master/contrib/monitordemo/src/com/sun/jna/contrib/demo/MonitorInfoDemo.java
 *
 * @author Martin Steiger
 */
class MonitorInfoDemo
{
    /**
     * @param args (ignored)
     */
    ...
    static void enumerate(HMONITOR hMonitor)
    {
        ...
        System.out.println("cb size: "+info.cbSize);
